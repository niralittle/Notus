...
<%@page import="nc.notus.entity.Task"%>
 ...
 <% if(request.getAttribute("newScenarioTasks") == null
        ...
        out.print("\n\nNo taks found! Get some from the pool.");
    } else {
        if(request.getAttribute("newScenarioTasks") != null) {
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="serviceorderid"
                           value="<%=task.getServiceOrderID()%>" readonly="readonly"/>
                </td>
                <td>
...
<%      if(request.getAttribute("disconnectScenarioTasks") != null) {
          List<Task> disconTasks =
                  (List) request.getAttribute("disconnectScenarioTasks");
%>
