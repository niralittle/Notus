...
<h3 style="color: red;"><%=request.getAttribute("errMessage") == null ? "" : request
					.getAttribute("errMessage")%></h3>
<h3 style="color: green;"><%=request.getAttribute("success") == null ? "" : request
					.getAttribute("success")%></h3>

<form id="get_users" method="get" action="GetUsers">
	<div id="passChange">
		<a onclick="hidetxt('div1'); return false;" href="#" rel="nofollow">Search
			by Last Name:</a>
	...
	<div id="passChange">
		<a onclick="hidetxt('div2'); return false;" href="#" rel="nofollow">Search
			by login:</a>
	...
	<div id="passChange">
		<a onclick="hidetxt('div3'); return false;" href="#" rel="nofollow">Search
			by email:</a>
