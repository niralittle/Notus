...
%>
	<li>
            <a href="ReassigTaskToEngineerServlet?page=<%=(currentPage - 1)%>&taskID=<%=taskId%>">&laquo;</a>
        </li>
<%
            }
...
%>
	<li>
            <a href="ReassigTaskToEngineerServlet?page=<%=(currentPage + 1)%>&taskID=<%=taskId%>">&raquo;</a>
        </li>
<%
            } else {
%>
