...
<form method="post" action="getReport" target="_blank" onsubmit="return continueOrNot()">
    ...
    <SELECT id="monthFrom"  disabled onChange="checkYear(this.form.dayFrom, this.form.monthFrom, this.form.yearFrom)">
        <SCRIPT LANGUAGE="JavaScript">
            displayMonth();
        </SCRIPT>
    </SELECT>
    <SELECT id="yearFrom"  disabled onChange="checkYear(this.form.dayFrom, this.form.monthFrom, this.form.yearFrom)">
        <SCRIPT LANGUAGE="JavaScript">
    ...
    <SELECT id="monthTo" disabled onChange="checkYear(this.form.dayTo, this.form.monthTo, this.form.yearTo)">
        <SCRIPT LANGUAGE="JavaScript">
            displayMonth();
        </SCRIPT>
    </SELECT>
    <SELECT id="yearTo" disabled onChange="checkYear(this.form.dayTo, this.form.monthTo, this.form.yearTo)">
        <SCRIPT LANGUAGE="JavaScript">
            displayYearVariable(5, 5);
        </SCRIPT>
    </SELECT>
